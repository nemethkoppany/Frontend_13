        ...
        <div>
          ...
          <div className="row">
            ...
            <div>
              ...
              {token ? (<button className="btn btn-danger" onClick={()=>{localStorage.removeItem("token");setToken(null)}

              }>Kijelentkezés</button>):(<Link className="btn btn-success" to="/login">Bejelentkezés</Link>)}
               </div>
          </div>
        </div>
      </div>
